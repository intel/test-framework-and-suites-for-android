...
if EXEC_UC.get_tc_expected_result() == Util.Verdict.PASS:
    VERDICT = SUCCESS
else:
    # Overriding expected result, to make the test fail
    # otherwise FAIL expected + VERDICT = FAIL => test is successful ...
    EXEC_UC._tc_parameters._attrs_override['TcExpectedResult'] = Util.Verdict.PASS
    VERDICT = FAIL
