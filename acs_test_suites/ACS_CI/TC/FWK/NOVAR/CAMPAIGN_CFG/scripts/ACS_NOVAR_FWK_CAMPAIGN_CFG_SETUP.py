...
# Create test cases for error cases
tc_list = ["CORRUPTED_TC", "EMPTY_TC", "UNKNOWN_TC"]

for tc_file in tc_list:
    print MY_PATH
    tc_file_path = os.path.join(MY_PATH, tc_file)
    os.rename(tc_file_path, tc_file_path + ".xml")
