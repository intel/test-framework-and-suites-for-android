...
from testlib.scripts.wireless.bluetooth.automotive_O import bluetooth_steps
from testlib.scripts.android.ui import ui_steps
from testlib.base.abstract.abstract_step import inherite
from testlib.scripts.wireless.bluetooth.automotive_O import bt_utils as parent_bt_utils
    ...
    if perform_action_first_on_initiator:
        if action_initiator == "Pair":
            ...
            if action_receiver == "Pair":
                ...
                time.sleep(4)
                ui_steps.click_button_common(serial=receiver_serial,
                                             view_to_find={"resourceId": "android:id/button1"}, optional=True)()
                ui_steps.click_button_common(serial=initiator_serial,
                                             view_to_find={"resourceId": "android:id/button1"}, optional=True)()
    ...
    # be treated
        ...
        if action_initiator == "Pair":
            if action_receiver == "Pair":
                ...
                bluetooth_steps.PerformActionPairRequest(serial=initiator_serial, action=action_initiator,
                                                         version=version_initiator, **kwargs)()
                ui_steps.click_button_common(serial=receiver_serial, view_to_find={"resourceId": "android:id/button1"},
                                             optional=True)()
                ui_steps.click_button_common(serial=initiator_serial,
                                             view_to_find={"resourceId": "android:id/button1"}, optional=True)()
            elif action_receiver == "Cancel":
...
@inherite(parent_bt_utils.get_sent_received_count)
